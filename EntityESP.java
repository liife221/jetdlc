...
public class EntityESP {
    ...
    public static void toggle() {
        isActive = !isActive;
        System.out.println("EntityESP " + (isActive ? "Enabled" : "Disabled"));
    }
    ...
    public static void onRenderWorldLast(RenderWorldLastEvent event) {
        ...
        for (LivingEntity entity : mc.level.getEntitiesOfClass(LivingEntity.class, mc.player.getBoundingBox().inflate(10.0))) {
            if (entity != mc.player && isValidTarget(entity)) {
                renderESP(entity, event.getPartialTicks());
            }
        }
    }
    ...
    private static void renderESP(LivingEntity entity, float partialTicks) {
        ...
        draw3DBox(pos, entity.getBbWidth(), entity.getBbHeight(), new Color(0, 255, 0, 120), new Color(0, 255, 0, 200));
